            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        default="/",
                        help_text=(
                            "URL to which user will be redirected after "
                            "logging in. ('/')"
                        ),
                        max_length=255,
                    ),
                ...
                (
                    ...
                    models.DateTimeField(
                        ...
                        help_text=(
                            "When the token is due to expire (uses DEFAULT_EXPIRY)"
                        ),
                    ),
                ),
                (
            ...
            fields=[
                ...
                (
                    ...
                    models.TextField(
                        blank=True,
                        help_text=(
                            "The client User-Agent, extracted from HttpRequest "
                            "headers"
                        ),
                    ),
                ),
                (
                    ...
                    models.BooleanField(
                        default=True,
                        help_text=(
                            "Snapshot of parent link is_valid property at the time "
                            "of use"
                        ),
                    ),
                ),
                (
                    "http_status_code",
                    models.IntegerField(
                        default=0, help_text="The HTTP response status code"
                    ),
                ),
                (
                    "link",
